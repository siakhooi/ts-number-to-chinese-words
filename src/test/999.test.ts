...
test.each([
  ...
  [492, '四百九十二'],
  [999, '九百九十九'],
])('integer-100-999 - default', (input: number, expected: string) => {
...
test.each([
  ...
  [492, '四百九十二'],
  [999, '九百九十九'],
])('integer-100-999 - simplified', (input: number, expected: string) => {
...
test.each([
  ...
  [492, '四百九十二'],
  [999, '九百九十九'],
])('integer-100-999 - traditional', (input: number, expected: string) => {
