...
import {data} from './data-contraction-50';
import {generate} from './TestUtils';

const TESTSUITE = 'Contraction_50';

export const option0: Options[] = [{useContraction50: true}];
export const option1: Options[] = [
  {useContraction50: true, useTraditional: true},
];
export const option2: Options[] = [{useContraction50: true, useCapital: true}];
export const option3: Options[] = [
  {useContraction50: true, useTraditional: true, useCapital: true},
];
