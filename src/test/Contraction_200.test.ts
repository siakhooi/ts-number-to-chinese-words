...
import {data} from './data-contraction-200';
import {generate} from './TestUtils';

const TESTSUITE = 'Contraction_200';

export const option0: Options[] = [{useContraction200: true}];
export const option1: Options[] = [
  {useContraction200: true, useTraditional: true},
];
export const option2: Options[] = [{useContraction200: true, useCapital: true}];
export const option3: Options[] = [
  {useContraction200: true, useTraditional: true, useCapital: true},
];
