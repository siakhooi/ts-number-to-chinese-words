...
test.each([
  ...
  [98, '九十八'],
  [99, '九十九'],
])('integer-10-99 - default', (input: number, expected: string) => {
...
test.each([
  ...
  [98, '九十八'],
  [99, '九十九'],
])('integer-10-99 - simplified', (input: number, expected: string) => {
...
test.each([
  ...
  [98, '九十八'],
  [99, '九十九'],
])('integer-10-99 - traditional', (input: number, expected: string) => {
