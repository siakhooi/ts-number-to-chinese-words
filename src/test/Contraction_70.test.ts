...
import {data} from './data-contraction-70';
import {generate} from './TestUtils';

const TESTSUITE = 'Contraction_70';

export const option0: Options[] = [{useContraction70: true}];
export const option1: Options[] = [
  {useContraction70: true, useTraditional: true},
];
export const option2: Options[] = [{useContraction70: true, useCapital: true}];
export const option3: Options[] = [
  {useContraction70: true, useTraditional: true, useCapital: true},
];
