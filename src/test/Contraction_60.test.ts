...
import {data} from './data-contraction-60';
import {generate} from './TestUtils';

const TESTSUITE = 'Contraction_60';

export const option0: Options[] = [{useContraction60: true}];
export const option1: Options[] = [
  {useContraction60: true, useTraditional: true},
];
export const option2: Options[] = [{useContraction60: true, useCapital: true}];
export const option3: Options[] = [
  {useContraction60: true, useTraditional: true, useCapital: true},
];
